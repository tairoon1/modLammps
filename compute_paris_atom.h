...
ComputeStyle(paris/atom,ComputeParisAtom)

#else

#ifndef LMP_COMPUTE_PARIS_ATOM_H
#define LMP_COMPUTE_PARIS_ATOM_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeParisAtom : public Compute {
 public:
  ComputeParisAtom(class LAMMPS *, int, char **);
  ~ComputeParisAtom();
  void init();
